#!/usr/bin/env python3
"""Controlled tournament for D128 attention-output projection fusion."""
...
def main() -> int:
    ...
    incumbent = MixedPrecisionTransformer(
        config, enable_attention_output_norm_fusion=False
    )
    challenger = MixedPrecisionTransformer(
        config, enable_attention_output_norm_fusion=True
    )
    ...
    names = ("incumbent", "fused_attention_output_norm")
